...
-   [Introdução ao R](#introdução-ao-r){#toc-introdução-ao-r}
    -   [Preparar o
        ambiente](#preparar-o-ambiente){#toc-preparar-o-ambiente}
    -   [Primeiros passos](#primeiros-passos){#toc-primeiros-passos}
        -   [Consola vs
            Script](#consola-vs-script){#toc-consola-vs-script}
        -   [Limpar o ambiente do
            `R`](#limpar-o-ambiente-do-r){#toc-limpar-o-ambiente-do-r}
        -   [Efetuar cálculos
            básicos](#efetuar-cálculos-básicos){#toc-efetuar-cálculos-básicos}
        -   [Criar objetos no
            `R`](#criar-objetos-no-r){#toc-criar-objetos-no-r}
        -   [Cálculos com
            objetos](#cálculos-com-objetos){#toc-cálculos-com-objetos}
-   [Importar dados
    externos](#importar-dados-externos){#toc-importar-dados-externos}
    -   [Instalar biblioteca `readxl` para ler ficheiros Excel. Para
        isso é necessário utilizar a função `install.packages` para
        instalar a
        biblioteca.](#instalar-biblioteca-readxl-para-ler-ficheiros-excel.-para-isso-é-necessário-utilizar-a-função-install.packages-para-instalar-a-biblioteca.){#toc-instalar-biblioteca-readxl-para-ler-ficheiros-excel.-para-isso-é-necessário-utilizar-a-função-install.packages-para-instalar-a-biblioteca.}
    -   [Carregar a
        biblioteca](#carregar-a-biblioteca){#toc-carregar-a-biblioteca}
    -   [Carregar dados com a funão
        `read_xlsx`](#carregar-dados-com-a-funão-read_xlsx){#toc-carregar-dados-com-a-funão-read_xlsx}
    -   [Estatística descritiva das
        variáveis](#estatística-descritiva-das-variáveis){#toc-estatística-descritiva-das-variáveis}
    -   [Calculos entre colunas de um data
        frame](#calculos-entre-colunas-de-um-data-frame){#toc-calculos-entre-colunas-de-um-data-frame}
-   [Análise de dados](#análise-de-dados){#toc-análise-de-dados}
    -   [Quantas casas têm 3
        divisões?](#quantas-casas-têm-3-divisões){#toc-quantas-casas-têm-3-divisões}
    -   [Quantas casas têm estilo
        colonial?](#quantas-casas-têm-estilo-colonial){#toc-quantas-casas-têm-estilo-colonial}
    -   [Quais os fatores que influenciam positivamente o preço das
        casa?](#quais-os-fatores-que-influenciam-positivamente-o-preço-das-casa){#toc-quais-os-fatores-que-influenciam-positivamente-o-preço-das-casa}
    -   [Será que a 1ª casa da amostra foi vendida abaixo ou acima do
        preço de
        mercado?](#será-que-a-1ª-casa-da-amostra-foi-vendida-abaixo-ou-acima-do-preço-de-mercado){#toc-será-que-a-1ª-casa-da-amostra-foi-vendida-abaixo-ou-acima-do-preço-de-mercado}
